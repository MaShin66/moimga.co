	...
	<div class="row justify-content-md-center">
		...
		<div class="col-lg-8 col-md-12 col-sm-12">
			...
			<div class="magazine_bottom">
				...
				<a href="/magazine" class="btn btn-round btn-outline-action ">목록</a>
				<?php if($user['user_id']==$result['user_id']){?>
					<a href="/magazine/upload?write=modify&id=<?=$result['magazine_id']?>" class="btn btn-round btn-outline-action">수정</a>
				<?php }?>
			</div>
		</div>
	</div>
